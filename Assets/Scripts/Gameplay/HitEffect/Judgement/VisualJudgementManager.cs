public class VisualJudgementManager : GameplayObjectPoolManager<VisualJudgementObject, VisualJudgementRenderBehavior>
{
    ...
    {
        TimerIntervalAction timerAction = new TimerIntervalAction(this, (x) => UnrenderObject_ReturnToPool(visualJudgementObject), () => { }, k_JUDGEMENTALIVETIME, TimerBehavior.MULTI, 0d, 1);
